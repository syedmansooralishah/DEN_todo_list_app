...
DEN Todo List is a simple and clean Flutter application designed to help users manage their daily tasks effectively. This app allows users to add, delete, and mark tasks as completed, offering a minimal yet functional to-do experience.
...
> ⚠️ Screenshots are currently not available. They will be added soon in a future update.
...
1. Clone the repo
   ...
   ```bash
   git clone https://github.com/syedmansooralishah/DEN_todo_list_app.git
   cd DEN_todo_list_app
   ```
...
> Make sure Flutter SDK is installed and properly set up.
